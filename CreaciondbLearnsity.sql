...
CREATE TABLE Dim_Usuario (
    ...
    ID_Usuario_CN INT,                            -- Clave Natural del origen [cite: 1]
    Nombre_Completo VARCHAR(300),                 -- Combinado de Nombre, Apellido_Paterno, Apellido_Materno [cite: 1]
    Correo VARCHAR(150),
    Fecha_Nacimiento DATE,
    -- Potencialmente añadir otros atributos derivados como Edad_Actual, Rango_Edad, etc. [cite: 1]
